...
import { isVNode, isRef, toValue } from 'file://C:/mySource/Vue/nuxt-board-mongodb/node_modules/vue/index.mjs';
...
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/mySource/Vue/nuxt-board-mongodb/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
...
const _rNt4utOohF0_VlgMsG9YUZX8gvwWYyBIE63lEyTlTs = (function(nitro) {
...
const _AmsjrNbhxRDwsLULTDQdeRE544haoHbu8DROOkIQ6sk = (nitroApp) => {
...
const plugins = [
  _rNt4utOohF0_VlgMsG9YUZX8gvwWYyBIE63lEyTlTs,
_AmsjrNbhxRDwsLULTDQdeRE544haoHbu8DROOkIQ6sk,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1d662-uLyFZfuzTtNEJRucT68P6rN7arg\"",
    "mtime": "2026-04-13T01:48:01.826Z",
    "size": 120418,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"74da9-BrZ6vW2uaLoriQEY256rpyiKck0\"",
    "mtime": "2026-04-13T01:48:01.826Z",
    "size": 478633,
    "path": "index.mjs.map"
  }
...
const _NMmCT7 = eventHandler((event) => {
...
const _hXdIWZ = defineEventHandler((event) => {
...
const _lazy_Mfnnoa = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_Bj4eJg = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_uYzhCq = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_V_cqmB = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_RGk9Qf = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_dzOs7o = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_EwBfid = () => Promise.resolve().then(function () { return create_post$1; });
const _lazy_i8HWVT = () => Promise.resolve().then(function () { return boards$1; });
const _lazy_tO62v5 = () => Promise.resolve().then(function () { return connectionTest$1; });
const _lazy_cCVvRI = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _NMmCT7, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _hXdIWZ, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_Mfnnoa, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_Bj4eJg, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/register', handler: _lazy_uYzhCq, lazy: true, middleware: false, method: "post" },
  { route: '/api/board/:id', handler: _lazy_V_cqmB, lazy: true, middleware: false, method: "delete" },
  { route: '/api/board/:id', handler: _lazy_RGk9Qf, lazy: true, middleware: false, method: "get" },
  { route: '/api/board/:id', handler: _lazy_dzOs7o, lazy: true, middleware: false, method: "put" },
  { route: '/api/board/create', handler: _lazy_EwBfid, lazy: true, middleware: false, method: "post" },
  { route: '/api/boards', handler: _lazy_i8HWVT, lazy: true, middleware: false, method: undefined },
  { route: '/api/connectionTest', handler: _lazy_tO62v5, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_cCVvRI, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_cCVvRI, lazy: true, middleware: false, method: undefined }
];
